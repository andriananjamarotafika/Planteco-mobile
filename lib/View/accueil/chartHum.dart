...
class ChartHum extends StatefulWidget {
  const ChartHum({Key? key}) : super(key: key);

  @override
  _LineChartSample2State createState() => _LineChartSample2State();
}

class _LineChartSample2State extends State<ChartHum> {
  List<Color> gradientColors = [
   Color.fromARGB(196, 33, 149, 243),
   Color.fromARGB(173, 83, 159, 222),
  ];
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      ...
      case 5:
        ...
        break;
      case 8:
        text = const Text('15h', style: style);
        break;
      default:
